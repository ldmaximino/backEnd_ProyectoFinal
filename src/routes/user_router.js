...
import { checkRoleAdmin } from "../middlewares/checkRole.js";
...
//Sets all users who last logged in more than X minutes ago to inactive
router.put(
  "/inactive",[
  refreshToken,
  passport.authenticate("current"),
  checkRoleAdmin],
  controller.checkUsersLastConnection
);
